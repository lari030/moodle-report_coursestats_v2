...
$string['coursescreated'] = 'Quantidade de cursos criados e visíveis';
...
$string['usageForum'] = 'Fórum de avisos';
$string['usageRepository'] = 'Repositório';
$string['usageActivity'] = 'Arcabouço de atividades';
